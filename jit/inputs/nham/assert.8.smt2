      ...
      (a!91 (ite (bvsle #x00000004 main@%_928_0)
                 ...
                 (ite (bvsle #x00000002 main@%_928_0)
                      (ite (= main@%_928_0 #x00000002)
                           ...
                           (ite a!90 a!74 a!78))
                      a!78)))
      (a!99 (ite (bvsle #x00000004 main@%_928_0)
                 (ite (bvsle #x00000006 main@%_928_0)
                      a!86
                      (ite (= main@%_928_0 #x00000005)
                           a!86
                 ...
                 (ite (bvsle #x00000002 main@%_928_0)
                      (ite (= main@%_928_0 #x00000002)
                           a!78
                           (ite a!85 a!74 a!86))
                      (ite (= main@%_928_0 #x00000001) a!70 a!86)))))
(let ((a!80 (ite (= main@%_1080_0 #x00000006)
      ...
      (a!95 (= (bvmul #x00000004
                      (ite (bvsle #x00000004 main@%_928_0) a!68 a!79))
               #x00000010))
      (a!98 (= (bvmul #x00000004
                      (ite (bvsle #x00000004 main@%_928_0) a!68 a!79))
               #x00000014))
      (a!103 (= (bvmul #x00000004
                       (ite (bvsle #x00000004 main@%_928_0) a!68 a!79))
                #x0000000c)))
(let ((a!81 (ite (bvsle #x00000006 main@%_1080_0)
      ...
      (a!92 (ite (bvsle #x00000002 main@%_1080_0)
                 ...
                 (ite (= main@%_1080_0 #x00000001)
                      a!91
                      (ite (bvsle #x00000004 main@%_928_0) a!68 a!79))))
      (a!96 (ite (bvsle #x00000004 main@%_1080_0)
                 a!83
                 (ite (bvsle #x00000002 main@%_1080_0)
                      (ite (= main@%_1080_0 #x00000002)
                           a!91
                           (ite a!95 a!87 a!83))
                      (ite (= main@%_1080_0 #x00000001) a!91 a!83))))
      (a!100 (ite (bvsle #x00000004 main@%_1080_0)
                  ...
                  (ite (bvsle #x00000002 main@%_1080_0)
                       (ite (= main@%_1080_0 #x00000002)
                            a!91
                            (ite a!98 a!87 a!99))
                       (ite (= main@%_1080_0 #x00000001) a!83 a!87))))
      (a!101 (ite (= main@%_1080_0 #x00000006)
                  (bvadd #x00000001
                         (ite (bvsle #x00000004 main@%_928_0) a!68 a!79))
                  a!89))
      (a!104 (ite (bvsle #x00000004 main@%_1080_0)
                  a!91
                  (ite (bvsle #x00000002 main@%_1080_0)
                       (ite (= main@%_1080_0 #x00000002)
                            a!91
                            (ite a!103 a!87 a!91))
                       a!91))))
(let ((a!93 (ite (= main@%_1232_0 #x00000006)
                 (bvadd #x00000001
                        (ite (bvsle #x00000004 main@%_1080_0) a!81 a!92))
                 (ite (bvsle #x00000004 main@%_1080_0) a!81 a!92)))
      (a!97 (= (bvmul #x00000004
                      (ite (bvsle #x00000004 main@%_1080_0) a!81 a!92))
               #x0000001c))
      (a!102 (ite (bvsle #x00000004 main@%_1080_0)
                  (ite (bvsle #x00000006 main@%_1080_0)
                       (ite (bvsle #x00000007 main@%_1080_0) a!89 a!101)
                       a!89)
                  (ite (bvsle #x00000002 main@%_1080_0)
                       (ite (= main@%_1080_0 #x00000002)
                            a!83
                            (ite a!84 a!87 a!89))
                       (ite (= main@%_1080_0 #x00000001) a!91 a!89)))))
(let ((a!94 (ite (bvsle #x00000006 main@%_1232_0)
                 (ite (bvsle #x00000007 main@%_1232_0)
                      (ite (bvsle #x00000004 main@%_1080_0) a!81 a!92)
                      a!93)
                 (ite (bvsle #x00000004 main@%_1080_0) a!81 a!92)))
      (a!105 (ite (bvsle #x00000002 main@%_1232_0)
                  (ite (= main@%_1232_0 #x00000002) a!96 (ite a!97 a!100 a!102))
                  (ite (= main@%_1232_0 #x00000001)
                       a!104
                       (ite (bvsle #x00000004 main@%_1080_0) a!81 a!92)))))
  (not (bvule #x00000005 (ite (bvsle #x00000004 main@%_1232_0) a!94 a!105))))))))))))))))))))))
