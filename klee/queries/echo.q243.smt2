; QueryHash 7195666668158242559
(set-logic QF_AUFBV )
(declare-fun arg00 () (Array (_ BitVec 32) (_ BitVec 8) ) )
(assert (let ( (?B1 (select  arg00 (_ bv1 32) ) ) ) (and  (and  (=  false (=  (_ bv45 8) ?B1 ) ) (=  false (=  (_ bv0 8) ?B1 ) ) ) (or  (=  (_ bv69 8) ?B1 ) (or  (=  (_ bv110 8) ?B1 ) (=  (_ bv101 8) ?B1 ) ) ) ) ) )
(check-sat)
(exit)
