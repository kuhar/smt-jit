; QueryHash 15655186245503471278
(set-logic QF_AUFBV )
(declare-fun arg00 () (Array (_ BitVec 32) (_ BitVec 8) ) )
(assert (let ( (?B1 (select  arg00 (_ bv7 32) ) ) ) (and  (and  (and  (=  false (=  (_ bv0 8) ?B1 ) ) (=  false (=  (_ bv101 8) ?B1 ) ) ) (=  false (=  (_ bv110 8) ?B1 ) ) ) (=  false (=  (_ bv69 8) ?B1 ) ) ) ) )
(check-sat)
(exit)
