; QueryHash 292970072832643286
(set-logic QF_AUFBV )
(declare-fun arg01 () (Array (_ BitVec 32) (_ BitVec 8) ) )
(assert (let ( (?B1 (select  arg01 (_ bv2 32) ) ) ) (let ( (?B2 (=  (_ bv69 8) ?B1 ) ) (?B3 (=  (_ bv110 8) ?B1 ) ) (?B4 (=  (_ bv101 8) ?B1 ) ) ) (and  (and  (and  (and  (=  false ?B4 ) (=  false ?B3 ) ) (=  false ?B2 ) ) (=  false (=  (_ bv0 8) ?B1 ) ) ) (or  ?B2 (or  ?B3 ?B4 ) ) ) ) ) )
(check-sat)
(exit)
