; QueryHash 10334505054324673293
(set-logic QF_AUFBV )
(declare-fun arg01 () (Array (_ BitVec 32) (_ BitVec 8) ) )
(assert (let ( (?B1 (select  arg01 (_ bv1 32) ) ) ) (and  (and  (and  (=  (_ bv58 8) ?B1 ) (=  false (=  (_ bv0 8) ?B1 ) ) ) (=  false (=  (_ bv45 8) ?B1 ) ) ) (=  (_ bv118 8) ((_ extract 7  0)  ((_ sign_extend 24)  ?B1 ) ) ) ) ) )
(check-sat)
(exit)
