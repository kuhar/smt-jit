; QueryHash 3472942255358606862
(set-logic QF_AUFBV )
(declare-fun arg01 () (Array (_ BitVec 32) (_ BitVec 8) ) )
(assert (let ( (?B1 (select  arg01 (_ bv5 32) ) ) ) (let ( (?B2 (=  (_ bv69 8) ?B1 ) ) ) (and  (and  (=  false ?B2 ) (=  false (=  (_ bv0 8) ?B1 ) ) ) (or  ?B2 (or  (=  (_ bv110 8) ?B1 ) (=  (_ bv101 8) ?B1 ) ) ) ) ) ) )
(check-sat)
(exit)
