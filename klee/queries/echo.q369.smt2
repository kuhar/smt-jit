; QueryHash 12210400936069988752
(set-logic QF_AUFBV )
(declare-fun arg00 () (Array (_ BitVec 32) (_ BitVec 8) ) )
(assert (let ( (?B1 (select  arg00 (_ bv8 32) ) ) ) (let ( (?B2 (=  (_ bv101 8) ?B1 ) ) (?B3 (=  (_ bv110 8) ?B1 ) ) (?B4 (=  (_ bv69 8) ?B1 ) ) ) (and  (and  (and  (and  (=  false ?B2 ) (=  false ?B3 ) ) (=  false ?B4 ) ) (=  false (=  (_ bv0 8) ?B1 ) ) ) (or  ?B4 (or  ?B3 ?B2 ) ) ) ) ) )
(check-sat)
(exit)
