; QueryHash 5218056317715970464
(set-logic QF_AUFBV )
(declare-fun arg00 () (Array (_ BitVec 32) (_ BitVec 8) ) )
(assert (let ( (?B1 (select  arg00 (_ bv2 32) ) ) ) (and  (and  (and  (and  (and  (=  false (=  (_ bv0 8) ?B1 ) ) (=  false (=  (_ bv61 8) ?B1 ) ) ) (=  false (=  (_ bv110 8) ?B1 ) ) ) (=  false (=  (_ bv115 8) ?B1 ) ) ) (=  false (=  (_ bv104 8) ?B1 ) ) ) (=  false (=  (_ bv118 8) ?B1 ) ) ) ) )
(check-sat)
(exit)
