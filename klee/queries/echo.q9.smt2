; QueryHash 12469119513649277126
(set-logic QF_AUFBV )
(declare-fun arg01 () (Array (_ BitVec 32) (_ BitVec 8) ) )
(assert (let ( (?B1 (select  arg01 (_ bv4 32) ) ) ) (and  (=  false (=  (_ bv0 8) ?B1 ) ) (or  (=  (_ bv55 8) ?B1 ) (or  (=  (_ bv54 8) ?B1 ) (or  (=  (_ bv53 8) ?B1 ) (or  (=  (_ bv52 8) ?B1 ) (or  (=  (_ bv51 8) ?B1 ) (or  (=  (_ bv50 8) ?B1 ) (=  (_ bv49 8) ?B1 ) ) ) ) ) ) ) ) ) )
(check-sat)
(exit)
