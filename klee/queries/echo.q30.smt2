; QueryHash 13785784156086609119
(set-logic QF_AUFBV )
(declare-fun arg01 () (Array (_ BitVec 32) (_ BitVec 8) ) )
(assert (let ( (?B1 (select  arg01 (_ bv4 32) ) ) ) (and  (and  (and  (=  false (=  (_ bv0 8) ?B1 ) ) (=  false (=  (_ bv101 8) ?B1 ) ) ) (=  false (=  (_ bv110 8) ?B1 ) ) ) (=  false (=  (_ bv69 8) ?B1 ) ) ) ) )
(check-sat)
(exit)
