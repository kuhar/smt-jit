; QueryHash 7369928694413788073
(set-logic QF_AUFBV )
(declare-fun arg00 () (Array (_ BitVec 32) (_ BitVec 8) ) )
(assert (let ( (?B1 (select  arg00 (_ bv4 32) ) ) ) (and  (and  (=  false (=  (_ bv84 8) ?B1 ) ) (=  false (=  (_ bv0 8) ?B1 ) ) ) (=  (_ bv84 8) ((_ extract 7  0)  ((_ sign_extend 24)  ?B1 ) ) ) ) ) )
(check-sat)
(exit)
